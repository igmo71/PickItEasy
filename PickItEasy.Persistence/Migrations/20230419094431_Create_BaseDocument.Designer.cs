...
namespace PickItEasy.Persistence.Migrations
{
    ...
    [Migration("20230419094431_Create_BaseDocument")]
    partial class Create_BaseDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PickItEasy.Domain.Entities.BaseDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PickItEasy.Domain.Entities.WhsOrderOutBaseDocument", b =>
                {
                    b.HasOne("PickItEasy.Domain.Entities.BaseDocument", "BaseDocument")
                        .WithMany()
                    ...
                    b.HasOne("PickItEasy.Domain.Entities.WhsOrderOut", "WhsOrderOut")
                        .WithMany("WhsOrderOutBaseDocuments")
            ...
            modelBuilder.Entity("PickItEasy.Domain.Entities.WhsOrderOut", b =>
                {
                    b.Navigation("WhsOrderOutBaseDocuments");
